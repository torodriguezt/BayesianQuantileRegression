...
model {
  ...
  alpha[col2] ~ normal(mu[muni2], sigma_cole);

  // Modelo para la variable respuesta utilizando vectorización y GPU
  target += skew_double_exponential_lpdf(y | alpha[cole] + beta_age * x + estrato_cen[estrato] + internet_cen[internet], 2 * sigma, tau);
}
...
generated quantities {
  ...
  // Cálculo de la variabilidad estandarizada
